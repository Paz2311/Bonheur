...
MOT="[Bb][Oo][Nn][Hh][Ee][Uu][RrSs]?"

for file in ../contextes/francais/fr_*.txt;
do
    lineno=$(echo "$file" | sed -E 's/.*fr_([0-9]+)\.txt/\1/')
    OUTPUT_FILE="../concordances/francais/fr_${lineno}.html"
